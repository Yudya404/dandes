      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('Instansi'); ?>">Data Jabatan</a>
            <a class="collapse-item" href="<?= base_url('Desa'); ?>">Data RT</a>
          </div>
        </div>
      </li>
<?php } ?>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('Dana_masuk'); ?>">Dana Masuk</a>
            <a class="collapse-item" href="<?= base_url('Dana_keluar'); ?>">Dana Keluar</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilitiess" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('Laporan'); ?>">Laporan Dana RT</a>
          </div>
        </div>
      </li>
